...
public class MyShopServeletList extends HttpServlet {
	
	List<MyShopDto> list = new Vector<MyShopDto>();
	
	public MyShopServeletList() {
		...
		list.add(new MyShopDto(400, "원피스", "25.jpg", 28000, "magenta"));
