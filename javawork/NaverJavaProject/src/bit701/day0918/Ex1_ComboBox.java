...
public class Ex1_ComboBox extends JFrame {
	...
	JRadioButton rbYellow, rbMagenta, rbGray, rbBlue;//체크박스 동시에, 라디오는 하나만
	JLabel lblMessgae; 
	...
	private void setDesign() {
		...
		//p 패널에 라벨 추가
		lblMessgae = new JLabel("Have a Nice Day");
		lblMessgae.setFont(new Font("Comic Sans MS", Font.BOLD, 30));
		p.add(lblMessgae);
		...
		//콤보박스 이벤트, 익명내부 클래스 형태로 오버라이딩 되고 연습으로 한다. 앱개발에 많이 사용됨.
		...
		rbYellow.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMessgae.setForeground(Color.yellow);
			}
		});
		...
		rbBlue.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMessgae.setForeground(Color.blue);
		...
		rbMagenta.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMessgae.setForeground(Color.magenta);
		...
		rbGray.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMessgae.setForeground(Color.gray);
