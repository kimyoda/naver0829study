...
class SuperA {
	...
	private void processC() {//상속이 안된다.private는 상속이 안된다
...
class SubA extends SuperA {
	public void show() {
		//this는자기 자신의 주소를 가진 인스턴스 변수이다
		//this 로 processA() 호출 시 현재 클래스에 없으면 부모로부터 찾아서 가져온다
		this.processA();
		this.processB();
...
public class Ex6_Inheri {
	...
	public static void main(String[] args) {
		...
		sub1.processA();
		sub1.processB();
		//sub1.processC();//상속 안됨(private은 패키지 상관없이 상속 안됨, 오류가 발생한다
		System.out.println("------");
		sub1.show();
