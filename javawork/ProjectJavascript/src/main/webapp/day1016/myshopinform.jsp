...
<form action="./myshopinsert.jsp" method="post">
	<table class="table tabel-bordered" style="width:300px; margin:30px 100px;">
		...
		<tr>
			...
			<td>
				<input type ="number" name = "price" class="form-control" required="required" step=500 max=1000000>
				</td>
		</tr>
		<tr>
