...
<script type="text/javascript">
	$(function(){
		...
		$("img.small").click(function(){
			...
			// es6의 리터럴 문자 사용시 -jsp 자체적으로 $ 기능이 있으므로 앞에 \를 붙여서 변수를 가져온다
			 location.href=`myshopdetail.jsp?num=\${num}`;
		});
	});
</script>
...
<h5 class="alert alert-danger" style="width:500px;">총 <%=list.size()%>개의 상품이 있습니다
<button type="button" class="btn btn-outline-info btn-sm" style="float: right" style="height:54px" onclick="location.href='myshopinform.jsp'">상품등록</button>
</h5>
</div>
<table class="table table-bordered shoptb">
	<thead>
		<tr>
			<th width="50">번호</th>
			<th width="150">상품명</th>
