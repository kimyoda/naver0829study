		   ...
		   $.each(res,function(idx, item) {
			   s += 
				   ...
				   <div class = "box">
			   	     ...
			   	     추천수 : \<span>\${item.likes}</span><i class = "bi bi-suit-heart increlikes" style = 
			   	    	 "cursor:pointer;color:red;margin-left:5px;" num="\${item.num}"></i><br>
...
<body>
  ...
  <div class = "memoform">
    	...
    	<input type = "text" id = "memo" class = "form-control" style = "width: 300px;" placeholder= "메모 메세지">
