		...
		success:function(res){
			...
			$.each(res,function(idx,item){
				s+=
					`
					<div class="box">
						<img src="\${item.photo80}" onerror = "this.src = '../res/upload/noimage.png'" width = 80 heigth = 80 align = left hspace = 10>
						<span>\${item.title}</span>
						<span style = "margin-left:20px;cursor:pointer;color:red;" class = "photodel" num = "\${item.num}">삭제</spa
					<br>
