...
public class TestMainEx2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. 스프링의 xml 설정 바식으로 객체 생성하기");
		...
		System.out.println(m3.hashCode() + "," + m3_1.hashCode()); // singleton은 여러번 생성해도 주소가 같다
		System.out.println(m4.hashCode() + "," + m4_1.hashCode()); // prototype은 생성할때마다 주소가 다르다
	}
