  ...
  <div style = "margin: 30px;width: 500px;">
    <h3><b>${dto.subject}</b></h3>
      <div style = "width: 500px;">
        ...
        <br><br>
        <button type = "button" class = "btn btn-outline-info btin-sm" style = "width: 80px" onclick = "location.href='./writeform'">글쓰기</button>
        
        <button type = "button" class = "btn btn-outline-info btin-sm" style = "width: 80px" onclick = "location.href='./list'">목록</button>
        
        
        <button type = "button" class = "btn btn-outline-info btin-sm" style = "width: 80px" onclick = "location.href='./updateform?num=${dto.num}'">수정</button>
        
        <button type = "button" class = "btn btn-outline-info btin-sm" style = "width: 80px" onclick = "location.href='./delete?num=${dto.num}'">삭제</button>
