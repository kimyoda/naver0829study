...
public class MemberDao {
	...
	public List<MemberDto> getSearchMember(String field, String word) {
		...
		// word에 검색단어가 안들어있을 경우 null 값을 보내야 where 문이 실행안된다
	...
	public MemberDto getData(String myid) {
		return session.selectOne(nameSpace + "selectDateById", myid); 
	}
	
	public MemberDto getData(int num) {
		return session.selectOne(nameSpace + "selectDateByNum", num); 
	}
