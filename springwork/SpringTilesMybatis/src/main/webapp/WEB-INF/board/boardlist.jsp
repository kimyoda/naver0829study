...
<body>
  <div>
	<h6 class = "alert alert-danger">총 ${totalCount}개의 글이 있습니다	
	
	  <c:if test = "${sessionScope.loginok!=null}">
	    <button type = "button" class = "btn btn-outline-danger btn-sm"  onclick="location.href='./form'" style="margin-left:300px;">글쓰기</button>
	  </c:if>
	</h6>
	...
	<div style="text-align: center;">
		...
		<c:if test="${startPage > 1}">
      	  <a href="./list?currentPage=${startPage - 1}" style="cursor: pointer;">이전</a>
   		</c:if>	
		&nbsp;
