...
<div>
	...
	<c:forEach var = "dto" items = "${glist}">
		<div class = "guest_box" style = "clear: both;">
		  ...
		  <span style = "margin-left: 30px;margin-right: 10px;color: gray;font-size: 0.9em">
			...
			<img src = "https://9wxfiwgh1725.edge.naverncp.com/VKUOTLws14/guest/${dto.guest_photo}?type=f&w=100&h=100"
...
<script type="text/javascript">
	$("img.smallphoto").click(function(){
		...
		//모달다이얼로그에 사진 넣기
		$("img.largephoto").attr("src",`https://kr.object.ncloudstorage.com/guest-kyh/guest/\${photoname}`);
	});
</script>
</body>
</html>